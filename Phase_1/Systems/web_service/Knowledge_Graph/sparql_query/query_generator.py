def make_query (print_variable, city, country, RunwaySurface, Aircraftmodel, agee):
	...
	Sparql_Query = Sparql_Query + "?accident aircraftaccident:occurredAtCity " +
	city1 + " . "                     + "?accident aircraftaccident:occurredAtCountry " + city1 + " . "	+ "?accident aircraftaccident:hasAircraft " + Aircraft1 + " . "              
	     + "?Aircraft hasAircraftModel " + Aircraftmodel1 + " . "                
	       + "?accident hasPilot " + pilot1 + " . "     + pilot1 + " hasAge ?Age ."                     + "?accident hasRunwaySurfaceType " + RunwaySurface + "
